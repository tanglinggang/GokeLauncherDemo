...
public class AppManagerDelegates extends AdapterDelegate<List<DisplayableItem>> {
    private LayoutInflater layoutInflater;
    private static List<DisplayableItem> mLists = new ArrayList<>();
    private Activity activity;

    public AppManagerDelegates(Activity activity) {
    ...
    @NonNull @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        final AppBeanViewHolder viewHolder = new AppBeanViewHolder(layoutInflater.inflate(R.layout.app_manager_recyclerview, parent, false));
        viewHolder.imageViewIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = activity.getPackageManager().getLaunchIntentForPackage(appBean.getPackageName());
    ...
    private static class AppBeanViewHolder extends RecyclerView.ViewHolder {
        ...
        private AppBeanViewHolder(View itemView) {
            super(itemView);
            imageViewIcon = (ImageView)itemView.findViewById(R.id.appManagerIcon);
            textView = (TextView)itemView.findViewById(R.id.appManagerName);
        }
    }
}
