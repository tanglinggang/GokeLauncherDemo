...
import com.example.wyman.gokelauncherdemo.AdapterDelegates.LauncherFunctionDelegates;
...
public class MainAdapter extends RecyclerView.Adapter {
  ...
  public MainAdapter(Activity activity, List<DisplayableItem> items) {
    ...
    delegatesManager.addDelegate(new LauncherFunctionDelegates(activity));
  }
