...
import com.example.wyman.gokelauncherdemo.AdapterDelegates.AppManagerDelegates;
...
public class AppManagerAdapter extends RecyclerView.Adapter {
  ...
  public AppManagerAdapter(Activity activity, List<DisplayableItem> items) {
    this.items = items;

    // Delegates
    delegatesManager = new AdapterDelegatesManager<>();
    delegatesManager.addDelegate(new AppManagerDelegates(activity));
  }
